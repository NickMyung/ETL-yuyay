...
def python_func(ds, **kwargs):
    ...
    blobs = storage_client.list_blobs("products_tktny", prefix="cutoff_date=2021-09-05/part")
...
with DAG(nameDAG,
         ...
         max_active_runs = 3,
         schedule_interval = "8,9,10,11,12 16 * * *") as dag: # schedule_interval = None # Caso sin trigger automático | schedule_interval = "0 12 * * *" | "0,2 12 * * *"
